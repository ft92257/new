...
INSERT INTO `pp_ad` (`id`, `board_id`, `type`, `name`, `url`, `code`, `image`, `start_time`, `end_time`, `clicks`, `add_time`, `ordid`, `status`) VALUES
...
INSERT INTO `pp_user` (`id`, `name`, `nickname`, `passwd`, `img`, `email`, `sex`, `ip`, `add_time`, `status`, `last_time`, `last_ip`, `tel`) VALUES
