...
<div class="pad-lr-10">
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            <td align="center"><input type="checkbox"  name="pid[]"  value="<?php echo ($val["pid"]); ?>"></td>
            <td align="center"><?php echo ($val["pid"]); ?></td>
            <td align="center"><?php echo ($val["title"]); ?></td>
			<td align="center"><?php echo ($val["create_time"]); ?></td>

            <td align="center">
            	<a href="javascript:edit(<?php echo ($val["pid"]); ?>,'<?php echo ($val["title"]); ?>')">编辑</a>
			</td>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'?s=/Project/edit/pid/'+id,width:'700',height:'500'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
