      ...
      <div id="div_setting_1" class="contentList pad-10">
        ...
        <tr>
          <th width="100">项目名称:</th>
          	<td>
            	<input type="text" name="title"  rel="title_color" class="input-text iColorPicker" size="53" value="<?php echo ($data["name"]); ?>" />
			</td>
		</tr>
		<tr>
            <th width="100">项目简介 :</th>
            <td><textarea class="input-text iColorPicker"  style=" width:400px; height:100px" name="content"><?php echo ($data["info"]); ?></textarea>
			</td>
        </tr> 
		<tr>
