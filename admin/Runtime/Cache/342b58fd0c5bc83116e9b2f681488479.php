...
<div class="pad-10" >
   ...
   <tr>
   <th width="20%">名称</th><th  width="15%">地区</th><th width="20%">地址</th><th width="20%">电话</th><th width="20%">邮箱</th><th width="5%">操作</th>
   </tr>
   <?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($val["name"]); ?></td><td><?php echo ($val["area"]); ?></td><td><?php echo ($val["address"]); ?></td><td><?php echo ($val["phone"]); ?></td><td><?php echo ($val["email"]); ?></td><td><a href="__URL__/edit?id=<?php echo ($val["id"]); ?>">编辑</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
   </table>
    <div class="btn">
