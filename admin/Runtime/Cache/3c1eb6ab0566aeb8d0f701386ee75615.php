          ...
          <tr>
            ...
            <td>
            	<input type="text" name="name" id="name" rel="title_color" 
                	class="input-text iColorPicker" size="60" value="<?php echo ($area["name"]); ?>" 
                    />            </td>
          </tr>            
          <tr>
            <th width="100">排序值 :</th>
            <td><input type="text" name="ordid" id="ordid" class="input-text" size="4" value="<?php echo ($style["ordid"]); ?>"></td>
          </tr>
        </table>
      </div>
