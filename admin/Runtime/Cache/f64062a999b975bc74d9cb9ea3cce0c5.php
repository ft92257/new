  ...
  <div class="pad-10">
    <div class="col-tab">
      <ul class="tabBut cu-li">
        	...
        	<li id="tab_setting_2" onclick="SwapTab('setting','on','',3,2);">首页设置</li>
        	<li id="tab_setting_3" onclick="SwapTab('setting','on','',3,3);">网站状态</li>
      </ul>
      ...
      <div id="div_setting_1" class="contentList pad-10">
          <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
            ...
            <tr>
              <th>默认搜索关键字 :</th>
              <td><input type="text" name="site[default_kw]" id="site_icp" class="input-text" value="<?php echo ($set["default_kw"]); ?>"></td>
            </tr>
            <tr>
              	<th>热门搜索:</th>
              	<td>
                    <textarea rows="2" cols="80" name="site[search_words]" id="search_words">
                        <?php echo ($set["search_words"]); ?>
                    </textarea>
            	</td>
        	</tr>            
            <tr>
            ...
            <tr>
              	<th>统计代码 :</th>
              	<td>
                    <textarea rows="4" cols="80" name="site[statistics_code]" id="statistics_code">
                        <?php echo ($set["statistics_code"]); ?>
                    </textarea>
            	</td>
        	</tr>
        </table>
      ...
      <div id="div_setting_2" class="contentList pad-10 hidden">
      	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">       
            <tr>
              <th width="100">是否显示专辑 :</th>
              <td>
                <input type="radio" <?php if($set["index_album"] == '1'): ?>checked="checked"<?php endif; ?> onclick="" value="1" name="site[index_album]"> 显示 &nbsp;&nbsp;
                <input type="radio" <?php if($set["index_album"] == '0'): ?>checked="checked"<?php endif; ?> onclick="" value="0" name="site[index_album]"> 不显示 &nbsp;&nbsp;
              </td>
            </tr>
            <tr>
              <th width="100">是否显示布瀑流 :</th>
              <td>
                <input type="radio" <?php if($set["index_pins"] == '1'): ?>checked="checked"<?php endif; ?> onclick="" value="1" name="site[index_pins]"> 显示 &nbsp;&nbsp;
