...
<div id="header">
    ...
    <div class="col-auto" style="overflow: visible">
        <div class="log white cut_line"> <?php echo (L("hello")); ?>！<?php echo ($my_info["user_name"]); ?>
            <span>|</span>
            <a href="<?php echo u('public/logout');?>">[<?php echo (L("logout")); ?>]</a> |
            <a onclick="$('#rightMain').attr('src','<?php echo u('public/panel');?>')" href="javascript:">[管理首页]</a>|
...
<div id="content">
    <div class="left_menu fl">
        <div id="leftMain"></div>
        <a href="javascript:;" id="openClose" style="outline-style: none; outline-color: invert; outline-width: medium;" hideFocus="hidefocus" class="open" title="<?php echo ($lang["expand_or_contract"]); ?>"></a> </div>
    <div class="right_main">
        <div class="crumbs">
            <div class="shortcut cu-span">
                ...
                <span><?php echo (L("refresh_page")); ?></span>
                </a> </div>
            <span id="current_pos"></span>
        </div>
        <div class="rmc">
            <div class="content" style="position:relative; overflow:hidden">
                <iframe name="right" id="rightMain" src="<?php echo u('public/panel');?>" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none;" width="100%" height="auto" allowtransparency="true"></iframe>
            </div>
        </div>
    </div>
</div>
