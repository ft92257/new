...
<div class="pad-lr-10">
    ...
    <table width="100%" cellspacing="0" class="search-form">
        <tbody>
            ...
            <div class="explain-col">
				链接分类 :  <select name="group_id" style="width:140px;">
                ...
                <input type="submit" name="search" class="button" value="搜索" /><font color=red>（警告：没事非专业人员请不要操作这里，会出乱子的噢@^^@）</font>
        	</div>
            </td>
            </tr>
        </tbody>
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($node_list)): $i = 0; $__LIST__ = $node_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><input type="text" class="input-text-c input-text" value="<?php echo ($val["sort"]); ?>" size="4" name="listorders[<?php echo ($val["id"]); ?>]"></td>
