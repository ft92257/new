...
<div class="pad-lr-10">
    <form id="myform" name="myform" action="<?php echo u('company/delete');?>" method="post" onsubmit="return check();">
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><?php echo ($val["region"]); ?></td>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'?m=company&a=edit&id='+id,width:'700',height:'500'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
