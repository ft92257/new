...
<div class="pad-10" >
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                <th width=40><?php echo (L("orders")); ?></th>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
           ...
           <td>
            <?php if($val["img"] == ''): ?><img src="__ROOT__/statics/admin/images/avatar-60.png" width="40px" height="40px"/>
            <?php else: ?>
                <img src="<?php echo ($val["img"]); ?>" width="40px" height="40px"/><?php endif; ?>
           </td>
           <td align="center"><a href="javascript:edit(<?php echo ($val["id"]); ?>,'<?php echo ($val["name"]); ?>')"><em class="blue"><?php echo ($val["name"]); ?></em></a></td>
           <td  align="center"><?php echo ($val["email"]); ?></td>
           <td align="center">
           <?php if($val["sex"] == '1'): ?>男
           <?php elseif($val["sex"] == '0'): ?>
           女
           <?php else: ?>
           保密<?php endif; ?>
           </td>
           ...
           <td align="center" onclick="status(<?php echo ($val["id"]); ?>,'status')" id="status_<?php echo ($val["id"]); ?>"><img src="__ROOT__/statics/images/status_<?php echo ($val["status"]); ?>.gif" /></td><?php endforeach; endif; else: echo "" ;endif; ?>
    	</tbody>
    </table>
    <div class="btn">
